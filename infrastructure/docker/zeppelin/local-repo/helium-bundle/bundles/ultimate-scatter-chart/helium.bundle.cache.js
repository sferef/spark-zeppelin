...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _bubble = __webpack_require__(8);
	...
	__webpack_require__(9)(_highcharts2.default);
	__webpack_require__(10)(_highcharts2.default);
	...
	var Chart = function (_Visualization) {
	    ...
	    var spec = {
	      charts: {
	        'scatter': {
	          ...
	          parameter: _scatter.CommonParameter
	        },
	        ...
	        'bubble': {
	          ...
	          parameter: _bubble.BubbleParameter
	        }
	      }
	    };
	  ...
	  _createClass(Chart, [{
	    ...
	    key: 'drawScatterChart',
	    value: function drawScatterChart(parameter, column, transformer) {
	      ...
	      var data = (0, _scatter.createScatterChartDataStructure)(rows, keyNames, selectors, parameter);
	      var chartOption = (0, _scatter.createScatterChartOption)(_highcharts2.default, data, parameter, keyNames);

	      this.chartInstance = _highcharts2.default.chart(this.getChartElementId(), chartOption);
	    }
	  }, {
	    key: 'drawBubbleChart',
	    value: function drawBubbleChart(parameter, column, transformer) {
	      ...
	      var data = (0, _bubble.createBubbleChartDataStructure)(rows, selectors);
	      var chartOption = (0, _bubble.createBubbleChartOption)(_highcharts2.default, data, parameter);
...
/***/ (function(module, exports) {
	...
	exports.createScatterChartDataStructure = createScatterChartDataStructure;
	exports.createScatterChartOption = createScatterChartOption;
	exports.parseNumberUsingHighchartPrecision = parseNumberUsingHighchartPrecision;
	...
	var PredefinedColorSets = ['rgba(0, 77, 255, 0.5)', 'rgba(255, 51, 0, 0.5)', 'rgba(179, 0, 255, 0.5)', 'rgba(102, 102, 102, 0.5)', 'rgba(51, 255, 102, 0.5)', 'rgba(179, 0, 255, 0.5)', 'rgba(51, 204, 255, 0.5)', 'rgba(255, 102, 51, 0.5)', 'rgba(204, 255, 51, 0.5)', 'rgba(245, 61, 0, 0.5)', 'rgba(102, 51, 255, 0.5)', 'rgba(51, 255, 204, 0.5)', 'rgba(255, 255, 51, 0.9)', /** yellow */
	'rgba(0, 184, 245, 0.5)', 'rgba(0, 138, 184, 0.5)', 'rgba(51, 102, 255, 0.5)', 'rgba(255, 51, 204, 0.5)', 'rgba(51, 255, 102, 0.5)', 'rgba(184, 46, 0, 0.5)', 'rgba(204, 51, 255, 0.5)', 'rgba(255, 51, 102, 0.5)', 'rgba(102, 255, 51, 0.5)', 'rgba(255, 204, 51, 0.5)'];

	function getPrecisionFormat(precision, prefix) {
	  return precision === '' ? '{' + prefix + ':.1f}' : '{' + prefix + ':' + precision + '}';
	}

	function createScatterChartDataStructure(rows, keyNames, selectors, parameter) {
	  var usePredefinedColorSet = parameter.usePredefinedColorSet;


	  var series = [];

	  var xAxisValues = keyNames.map(function (kn) {
	    var x = null;
	  ...
	  for (var i = 0; i < selectors.length; i++) {
	    ...
	    for (var j = 0; j < xAxisValues.length; j++) {
	      ...
	      if (xAxisValue !== null && yAxisValue !== null) {
	        var sRow = [xAxisValue, yAxisValue];
	        s.data.push(sRow);
	      }
	    }
	...
	function createScatterChartOption(Highcharts, data, parameter, keyNames) {
	  var xAxisName = parameter.xAxisName,
	      ...
	      markerRadius = parameter.markerRadius;
	      ...
	      scatter: {
	        ...
	        tooltip: {
	          ...
	          pointFormatter: function pointFormatter() {
	            var xValue = parseNumberUsingHighchartPrecision(Highcharts, tooltipPrecision, this.x);
	            var yValue = parseNumberUsingHighchartPrecision(Highcharts, tooltipPrecision, this.y);
	...
	function parseNumberUsingHighchartPrecision(Highcharts, precision, value) {
	  try {
	    if (precision !== '' && precision.startsWith('.') && precision.endsWith('f')) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.BubbleParameter = undefined;
	exports.createBubbleChartDataStructure = createBubbleChartDataStructure;
	exports.createBubbleChartOption = createBubbleChartOption;

	var _scatter = __webpack_require__(7);

	var BubbleParameter = exports.BubbleParameter = {
	...
	function createBubbleChartDataStructure(rows, selectors) {
	  var series = [];
	  ...
	  for (var i = 0; i < selectors.length; i++) {
	    ...
	    var selectorRows = rows[i].value;
	    for (var j = 0; j < selectorRows.length; j++) {
	      var r = selectorRows[j];

	      try {
	        var xValue = typeof r.key1 !== 'number' ? parseFloat(r.key1) : r.key1;
	        var yValue = typeof r.key2 !== 'number' ? parseFloat(r.key2) : r.key2;
	        var zValue = typeof r.aggregated !== 'number' ? parseFloat(r.aggregated) : r.aggregated;
	...
	function createBubbleChartOption(Highcharts, data, parameter) {
	  var xAxisName = parameter.xAxisName,
	      yAxisName = parameter.yAxisName,
	      xAxisUnit = parameter.xAxisUnit,
	      yAxisUnit = parameter.yAxisUnit,
	      zAxisUnit = parameter.zAxisUnit,
	      xAxisPosition = parameter.xAxisPosition,
	      yAxisPosition = parameter.yAxisPosition,
	      legendPosition = parameter.legendPosition,
	      legendLayout = parameter.legendLayout,
	      ...
	      mainTitle = parameter.mainTitle,
	      subTitle = parameter.subTitle,
	      plotBorderWidth = parameter.plotBorderWidth,
	      xGridLineWidth = parameter.xGridLineWidth,
	      yGridLineWidth = parameter.yGridLineWidth,
	      minBubbleSize = parameter.minBubbleSize,
	      maxBubbleSize = parameter.maxBubbleSize;
	  ...
	  var option = {
	    ...
	    tooltip: {
	      headerFormat: '<b style="color:{series.color}">{series.name}</b><br>',
	      pointFormatter: function pointFormatter() {
	        var xValue = (0, _scatter.parseNumberUsingHighchartPrecision)(Highcharts, tooltipPrecision, this.x);
	        var yValue = (0, _scatter.parseNumberUsingHighchartPrecision)(Highcharts, tooltipPrecision, this.y);
	        var zValue = (0, _scatter.parseNumberUsingHighchartPrecision)(Highcharts, tooltipPrecision, this.z);
