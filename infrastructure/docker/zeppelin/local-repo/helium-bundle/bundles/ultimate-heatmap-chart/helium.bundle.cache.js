...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(8)(_highcharts2.default);
	...
	var Chart = function (_Visualization) {
	    ...
	    var spec = {
	      charts: {
	        'heatmap': {
	          ...
	          parameter: _heatmap.HeatmapParameter
	        }
	  ...
	  _createClass(Chart, [{
	    ...
	    key: 'drawHeatmapChart',
	    value: function drawHeatmapChart(parameter, column, transformer) {
	      ...
	      var _transformer = transformer(),
	          ...
	          key1Names = _transformer.key1Names,
	          key2Names = _transformer.key2Names,
	          key1NameWithIndex = _transformer.key1NameWithIndex,
	          key2NameWithIndex = _transformer.key2NameWithIndex;

	      var data = (0, _heatmap.createHeatmapChartDataStructure)(rows, key1NameWithIndex, key2NameWithIndex, selectors, parameter);
	      var chartOption = (0, _heatmap.createHeatmapChartOption)(_highcharts2.default, data, parameter, key1Names, key2Names);

	      this.chartInstance = _highcharts2.default.chart(this.getChartElementId(), chartOption);
	    }
	  }, {
	    key: 'drawTreeChart',
	    value: function drawTreeChart(parameter, column, transformer) {
	      ...
	      var _transformer2 = transformer(),
	          ...
	          key1Names = _transformer2.key1Names,
	          key2Names = _transformer2.key2Names,
	          key1NameWithIndex = _transformer2.key1NameWithIndex,
	          key2NameWithIndex = _transformer2.key2NameWithIndex;

	      var data = createTreeChartDataStructure(rows, selectors);
	      var chartOption = createTreeChartOption(_highcharts2.default, data, parameter);
...
/***/ (function(module, exports) {
	...
	exports.createHeatmapChartDataStructure = createHeatmapChartDataStructure;
	exports.createHeatmapChartOption = createHeatmapChartOption;
	exports.parseNumberUsingHighchartPrecision = parseNumberUsingHighchartPrecision;
	var HeatmapParameter = exports.HeatmapParameter = {
	...
	function createHeatmapChartDataStructure(rows, key1NameWithIndex, key2NameWithIndex, selectors, parameter) {
	  var showDataLabel = parameter.showDataLabel,
	      seriesBorderColor = parameter.seriesBorderColor,
	      seriesBorderWidth = parameter.seriesBorderWidth;
	  ...
	  for (var i = 0; i < selectors.length; i++) {
	    ...
	    for (var j = 0; j < selectorRows.length; j++) {
	      ...
	      try {
	        var xValueIndex = key1NameWithIndex[r.key1];
	        var yValueIndex = key2NameWithIndex[r.key2];
	...
	function createHeatmapChartOption(Highcharts, data, parameter, key1Names, key2Names) {
	  var xAxisName = parameter.xAxisName,
	      ...
	      legendAlign = parameter.legendAlign,
	      ...
	      colorAxisMaxColor = parameter.colorAxisMaxColor,
	      colorAxisMinColor = parameter.colorAxisMinColor,
	      useColorAxisMin = parameter.useColorAxisMin,
	      colorAxisMinValue = parameter.colorAxisMinValue,
	      useColorAxisMax = parameter.useColorAxisMax,
	      colorAxisMaxValue = parameter.colorAxisMaxValue,
	      colorAxisStops = parameter.colorAxisStops,
	      mainTitle = parameter.mainTitle,
	      subTitle = parameter.subTitle,
	      plotBorderWidth = parameter.plotBorderWidth,
	      yAxisGridLineWidth = parameter.yAxisGridLineWidth;
	  ...
	  var option = {
	    ...
	    tooltip: {
	      pointFormatter: function pointFormatter() {
	        var zValue = parseNumberUsingHighchartPrecision(Highcharts, tooltipPrecision, this.value);
	  ...
	  if (useColorAxisMin) {
	    option.colorAxis.min = colorAxisMinValue;
	  }
	  if (useColorAxisMax) {
	    option.colorAxis.min = colorAxisMaxValue;
	  }
