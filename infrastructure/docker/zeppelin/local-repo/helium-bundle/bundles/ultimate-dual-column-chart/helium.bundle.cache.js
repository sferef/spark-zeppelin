...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _stacked = __webpack_require__(9);

	var _percent = __webpack_require__(10);

	var _drillDown = __webpack_require__(11);
	...
	__webpack_require__(13)(_highcharts2.default);
	...
	var Chart = function (_Visualization) {
	    ...
	    var spec = {
	      charts: {
	        'column': {
	          ...
	          parameter: _column.CommonParameter
	        }
	      }
	    };
	  ...
	  _createClass(Chart, [{
	    ...
	    key: 'drawColumnChart',
	    value: function drawColumnChart(parameter, column, transformer, axis) {
	      ...
	      var _transformer = transformer(),
	          ...
	          keyNames = _transformer.keyNames,
	          selectors = _transformer.selectors;
	      /*const t = transformer()
	      console.log(JSON.stringify(t, null, '\t'))*/


	      var data = (0, _column.createColumnChartDataStructure)(rows, axis);
	      console.log(JSON.stringify(data, null, '\t'));
	      var chartOption = (0, _column.createColumnChartOption)(data, parameter, keyNames, selectors);

	      this.chartInstance = _highcharts2.default.chart(this.getChartElementId(), chartOption);
	    }
	  }, {
	    key: 'drawStackedChart',
	    value: function drawStackedChart(parameter, column, transformer) {
	      if (column.aggregator.length === 0) {
	        this.hideChart();
	        return; /** have nothing to display, if aggregator is not specified at all */
	      }
	      ...
	      var _transformer2 = transformer(),
	          ...
	          keyNames = _transformer2.keyNames,
	          selectors = _transformer2.selectors;

	      var data = (0, _column.createColumnChartDataStructure)(rows);
	      var chartOption = (0, _stacked.createStackedColumnOption)(data, parameter, keyNames, selectors);

	      this.chartInstance = _highcharts2.default.chart(this.getChartElementId(), chartOption);
	    }
	  }, {
	    key: 'drawPercentChart',
	    value: function drawPercentChart(parameter, column, transformer) {
	      if (column.aggregator.length === 0) {
	        this.hideChart();
	        return; /** have nothing to display, if aggregator is not specified at all */
	      }
	      ...
	      var _transformer3 = transformer(),
	          ...
	          keyNames = _transformer3.keyNames,
	          selectors = _transformer3.selectors;

	      var data = (0, _column.createColumnChartDataStructure)(rows);
	      var chartOption = (0, _percent.createPercentColumnOption)(data, parameter, keyNames, selectors);

	      this.chartInstance = _highcharts2.default.chart(this.getChartElementId(), chartOption);
	    }
	  }, {
	    key: 'drawDrilldownChat',
	    value: function drawDrilldownChat(parameter, column, transformer) {
	      if (column.aggregator.length === 0) {
	        this.hideChart();
	        return; /** have nothing to display, if aggregator is not specified at all */
	      }

	      var _transformer4 = transformer(),
	          rows = _transformer4.rows,
	          keyNames = _transformer4.keyNames,
	          selectors = _transformer4.selectors;

	      var _createDrilldownDataS = (0, _drillDown.createDrilldownDataStructure)(rows),
	          series = _createDrilldownDataS.series,
	          drillDownSeries = _createDrilldownDataS.drillDownSeries;

	      var chartOption = (0, _drillDown.createDrilldownColumnOption)(series, drillDownSeries, parameter, keyNames, selectors);
...
/***/ (function(module, exports) {
	...
	exports.createColumnChartDataStructure = createColumnChartDataStructure;
	exports.createColumnChartOption = createColumnChartOption;
	...
	function createColumnChartDataStructure(rows, axis) {
	  //console.log(JSON.stringify(rows, null, '\t'))
	  var rightAxes = axis.yAxisRight;

	  return rows.map(function (r) {
	    console.log(JSON.stringify(rightAxes, null, '\t'));
	    var axisSide = 0;
	    var axisType = "column";

	    for (var i = 0; i < rightAxes.length; i++) {
	      var tempName = rightAxes[i].name + "(" + rightAxes[i].aggr + ")";
	      console.log(tempName + " === " + r.selector);
	      if (tempName === r.selector) {
	        axisSide = 1;
	        axisType = "spline";
	      }
	    }

	    return { name: r.selector, data: r.value, yAxis: axisSide, type: axisType };
	  });
	}

	function createColumnChartOption(data, parameter, keyNames) {
	  var xAxisName = parameter.xAxisName,
	      yAxisName = parameter.yAxisName,
	      xAxisUnit = parameter.xAxisUnit,
	      yAxisUnit = parameter.yAxisUnit,
	      xAxisPosition = parameter.xAxisPosition,
	      yAxisPosition = parameter.yAxisPosition,
	      legendPosition = parameter.legendPosition,
	      legendLayout = parameter.legendLayout,
	      rotateXAxisLabel = parameter.rotateXAxisLabel,
	      rotateYAxisLabel = parameter.rotateYAxisLabel,
	      zoomType = parameter.zoomType,
	      showLegend = parameter.showLegend,
	      legendLabelFormat = parameter.legendLabelFormat,
	      floatingLegend = parameter.floatingLegend,
	      dataLabel = parameter.dataLabel,
	      dataLabelRotation = parameter.dataLabelRotation,
	      tooltipPrecision = parameter.tooltipPrecision,
	      dataLabelPrecision = parameter.dataLabelPrecision,
	      mainTitle = parameter.mainTitle,
	      subTitle = parameter.subTitle,
	      inverted = parameter.inverted;
	  ...
	  var option = {
	    ...
	    tooltip: {
	      ...
	      pointFormat: '<tr><td style="color:{series.color};padding:0">{series.name}: </td>' + ('<td style="padding:0"><b>' + getPrecisionFormat(tooltipPrecision, 'point.y') + '</b></td></tr>'),
	      footerFormat: '</table>',
	      shared: true,
	      useHTML: true
	    },
	  ...
	  if (xAxisName !== '') {
	    option.xAxis.title = { text: xAxisName };
	  }
	  if (yAxisName !== '') {
	    option.yAxis.title = { text: yAxisName };
	  }
	  if (xAxisUnit !== '') {
	    option.xAxis.labels = { format: '{value} ' + xAxisUnit };
	  }
	  if (yAxisUnit !== '') {
	    option.yAxis.labels = { format: '{value} ' + yAxisUnit };
	  }
	  if (zoomType !== 'none') {
	    option.chart.zoomType = zoomType;
	  }
	  if (xAxisPosition === 'top') {
	    option.xAxis.opposite = true;
	  }
	  if (yAxisPosition === 'right') {
	    option.yAxis.opposite = true;
	  }
	  ...
	  if (dataLabel) {
	    var format = getPrecisionFormat(dataLabelPrecision, 'point.y');
	    option.series.map(function (r) {
	      r.dataLabels = {
	        enabled: true,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.StackedParameter = undefined;
	exports.createStackedColumnOption = createStackedColumnOption;

	var _column = __webpack_require__(8);

	var p = JSON.parse(JSON.stringify(_column.CommonParameter));
	var StackedParameter = exports.StackedParameter = p;
	p.dataLabelRotation.defaultValue = 0;

	function createStackedColumnOption(data, parameter, keyNames) {
	  var option = (0, _column.createColumnChartOption)(data, parameter, keyNames);

	  var dataLabel = parameter.dataLabel,
	      tooltipPrecision = parameter.tooltipPrecision;


	  if (dataLabel) {
	    option.series.map(function (r) {
	      r.dataLabels.align = 'center';
	    });
	  }
	  ...
	  option.tooltip = {
	    ...
	    pointFormat: '\n        <tr>\n          <th style="color: {series.color}">{series.name}: </th>\n          <td style="text-align: right">' + (0, _column.getPrecisionFormat)(tooltipPrecision, 'point.y') + '</td>\n        </tr>',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.PercentParameter = undefined;
	exports.createPercentColumnOption = createPercentColumnOption;

	var _column = __webpack_require__(8);

	var p = JSON.parse(JSON.stringify(_column.CommonParameter));
	var PercentParameter = exports.PercentParameter = p;
	p.dataLabelRotation.defaultValue = 0;
	...
	function createPercentColumnOption(data, parameter, keyNames) {
	  var option = (0, _column.createColumnChartOption)(data, parameter, keyNames);

	  var dataLabel = parameter.dataLabel,
	      tooltipPrecision = parameter.tooltipPrecision,
	      tooltipPercentagePrecision = parameter.tooltipPercentagePrecision;
	  ...
	  option.tooltip = {
	    headerFormat: '\n        <table class="tip">\n          <caption style="margin-bottom: 3px;">Key: {point.key}</caption>\n          <tbody>',
	    pointFormat: '\n        <tr>\n          <th style="color: {series.color}">{series.name}: </th>\n          <td style="text-align: right">\n            <b>' + (0, _column.getPrecisionFormat)(tooltipPrecision, 'point.y') + '</b>\n            (' + (0, _column.getPrecisionFormat)(tooltipPercentagePrecision, 'point.percentage') + ' %)\n          </td>\n        </tr>',
	    footerFormat: '</table></tbody>',
	    shared: true,
	    useHTML: true
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.DrillDownParameter = undefined;
	exports.createDrilldownColumnOption = createDrilldownColumnOption;
	exports.createDrilldownDataStructure = createDrilldownDataStructure;

	var _column = __webpack_require__(8);

	var p = JSON.parse(JSON.stringify(_column.CommonParameter));
	var DrillDownParameter = exports.DrillDownParameter = p;
	p.dataLabelRotation.defaultValue = 0;
	p.rotateXAxisLabel.defaultValue = -45;
	p.zoomType.defaultValue = 'none';

	function createDrilldownColumnOption(series, drillDownSeries, parameter) {
	  var option = (0, _column.createColumnChartOption)([], parameter);
	...
	function createDrilldownDataStructure(rows) {
	  var drillDownSeries = [];
	  var data = [];
